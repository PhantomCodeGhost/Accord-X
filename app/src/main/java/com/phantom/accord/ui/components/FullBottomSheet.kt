package com.phantom.accord.ui.components
...
import com.phantom.accord.logic.animateText
import com.phantom.accord.logic.checkIfNegativeOrNullOrMaxedOut
import com.phantom.accord.logic.dpToPx
import com.phantom.accord.logic.fadInAnimation
import com.phantom.accord.logic.fadOutAnimation
import com.phantom.accord.logic.getFile
import com.phantom.accord.logic.getLyrics
import com.phantom.accord.logic.getTextViews
import com.phantom.accord.logic.getTimer
import com.phantom.accord.logic.hasImagePermission
import com.phantom.accord.logic.hasScopedStorageV1
import com.phantom.accord.logic.hasScopedStorageWithMediaTypes
import com.phantom.accord.logic.hasTimer
import com.phantom.accord.logic.playOrPause
import com.phantom.accord.logic.resetShader
import com.phantom.accord.logic.scaleText
import com.phantom.accord.logic.setTextAnimation
import com.phantom.accord.logic.setTimer
import com.phantom.accord.logic.ui.CustomSmoothScroller
import com.phantom.accord.logic.ui.coolCrossfade
import com.phantom.accord.logic.updateMargin
import com.phantom.accord.logic.utils.CalculationUtils
...
class FullBottomSheet @JvmOverloads constructor(
    ...
    init {
        ...
        bottomSheetMoreButton.setOnClickListener(moreButtonClickListener)
        bottomSheetMoreButtonPlaylist.setOnClickListener(moreButtonClickListener)
