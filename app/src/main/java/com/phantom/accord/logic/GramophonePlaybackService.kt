...
package com.phantom.accord.logic
...
import com.phantom.accord.logic.utils.CircularShuffleOrder
import com.phantom.accord.logic.utils.LastPlayedManager
import com.phantom.accord.logic.utils.LrcUtils.extractAndParseLyrics
import com.phantom.accord.logic.utils.LrcUtils.loadAndParseLyricsFile
import com.phantom.accord.logic.utils.MediaStoreUtils
import com.phantom.accord.logic.utils.exoplayer.EndedWorkaroundPlayer
import com.phantom.accord.logic.utils.exoplayer.GramophoneMediaSourceFactory
import com.phantom.accord.logic.utils.exoplayer.GramophoneRenderFactory
...
class GramophonePlaybackService : MediaLibraryService(), MediaSessionService.Listener,
    ...
    override fun onMediaItemTransition(mediaItem: MediaItem?, reason: Int) {
        if (timerDuration == -1 && reason == Player.MEDIA_ITEM_TRANSITION_REASON_AUTO) {
            controller?.pause()
            timerDuration = 0
        }
        lyrics = null
    ...
    override fun onEvents(player: Player, events: Player.Events) {
        ...
        com.phantom.accord.ui.widgets.PlaybackWidgetProvider.notifyUpdate(this@GramophonePlaybackService, player)
